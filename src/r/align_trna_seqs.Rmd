...
seqs_split <- split(seqs, f = metadata(seqs)$trna)
...
```{r}
msaPrettyPrint(alignments[['Undet']], output = "pdf", showNames = "left", showLogo = "top", askForOverwrite = FALSE, verbose = FALSE, file = "undet_whole_align.pdf")
```
